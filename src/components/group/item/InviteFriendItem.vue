...
<template>
  <div class="col-lg-5 friend-card">
    <div class="friend-header-container">
      ...
      <button v-if="!isAlreadyGroupMember" class="invite-btn" @click.prevent="inviteFriend">
        초대
      </button>
    </div>
